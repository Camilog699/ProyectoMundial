...
public class TablaPosiciones {
    ...
    public void setPosiciones() {
        equipos.sort((o1, o2) -> o2.getPuntos() - o1.getPuntos());
        for (int i = 1; i < equipos.size(); i++) {
            if (equipos.get(i).getPuntos() == equipos.get(i - 1).getPuntos()) {
                equipos.sort((o1, o2) -> o2.diferenciaGoles() - o1.diferenciaGoles());
                break;
            }
        }
